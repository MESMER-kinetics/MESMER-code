...
/* Generated on Tue Nov 13 17:39:30 EST 2007 */

#include "codelet-dft.h"

#ifdef HAVE_FMA

/* Generated by: ../../../genfft/gen_twiddle_c -fma -reorder-insns -schedule-for-pipeline -simd -compact -variables 4 -pipeline-latency 8 -n 25 -name t1buv_25 -include t1bu.h -sign 1 */

/*
 * This function contains 248 FP additions, 241 FP multiplications,
 * (or, 67 additions, 60 multiplications, 181 fused multiply/add),
 * 208 stack variables, and 50 memory accesses
 */
#include "t1bu.h"

static void t1buv_25(R *ri, R *ii, const R *W, stride rs, INT mb, INT me, INT ms)
{
...
static const ct_desc desc = { 25, "t1buv_25", twinstr, &GENUS, {67, 60, 181, 0}, 0, 0, 0 };

void X(codelet_t1buv_25) (planner *p) {
     X(kdft_dit_register) (p, t1buv_25, &desc);
}
#else				/* HAVE_FMA */

/* Generated by: ../../../genfft/gen_twiddle_c -simd -compact -variables 4 -pipeline-latency 8 -n 25 -name t1buv_25 -include t1bu.h -sign 1 */

/*
 * This function contains 248 FP additions, 188 FP multiplications,
 * (or, 171 additions, 111 multiplications, 77 fused multiply/add),
 * 100 stack variables, and 50 memory accesses
 */
#include "t1bu.h"
...
static const ct_desc desc = { 25, "t1buv_25", twinstr, &GENUS, {171, 111, 77, 0}, 0, 0, 0 };
