...
/* Generated on Tue Nov 13 17:36:17 EST 2007 */

#include "codelet-dft.h"

#ifdef HAVE_FMA

/* Generated by: ../../../genfft/gen_twiddle_c -fma -reorder-insns -schedule-for-pipeline -simd -compact -variables 4 -pipeline-latency 8 -n 25 -name t1fuv_25 -include t1fu.h */
...
static void t1fuv_25(R *ri, R *ii, const R *W, stride rs, INT mb, INT me, INT ms)
{
...
static const ct_desc desc = { 25, "t1fuv_25", twinstr, &GENUS, {67, 60, 181, 0}, 0, 0, 0 };

void X(codelet_t1fuv_25) (planner *p) {
     X(kdft_dit_register) (p, t1fuv_25, &desc);
}
#else				/* HAVE_FMA */

/* Generated by: ../../../genfft/gen_twiddle_c -simd -compact -variables 4 -pipeline-latency 8 -n 25 -name t1fuv_25 -include t1fu.h */

/*
 * This function contains 248 FP additions, 188 FP multiplications,
 * (or, 170 additions, 110 multiplications, 78 fused multiply/add),
 * 99 stack variables, and 50 memory accesses
 */
#include "t1fu.h"
...
static const ct_desc desc = { 25, "t1fuv_25", twinstr, &GENUS, {170, 110, 78, 0}, 0, 0, 0 };
