...
extern void X(codelet_t1fuv_20)(planner *);
extern void X(codelet_t1fuv_25)(planner *);
...
extern void X(codelet_t1buv_20)(planner *);
extern void X(codelet_t1buv_25)(planner *);
...
const solvtab X(solvtab_dft_simd) = {
   ...
   SOLVTAB(X(codelet_t1fuv_20)),
   SOLVTAB(X(codelet_t1fuv_25)),
   ...
   SOLVTAB(X(codelet_t1buv_20)),
   SOLVTAB(X(codelet_t1buv_25)),
