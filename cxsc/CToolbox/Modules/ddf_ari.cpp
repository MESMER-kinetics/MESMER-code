...
//----------------------------------------------------------------------------
// Access functions for function and derivative values (see ddf_ari.hpp)
//----------------------------------------------------------------------------
// inline interval fValue ( const DerivType& u )                  // Get function value
//  { return u.f; }                                        //-------------------
//
// inline interval dfValue ( const DerivType& u )            // Get 1. derivative value
//  { return u.df; }                                  //------------------------
//
// inline interval ddfValue ( const DerivType& u )           // Get 2. derivative value
//  { return u.ddf; }                                 //------------------------
...
DerivType operator/ ( const real& u, const DerivType& v )
  { return( _interval(u) / v ); }    // Can propagate 'division by zero' error
                                     //---------------------------------------
DerivType operator+ ( const DerivType& u, const real& v )
  { return( u + _interval(v) ); }
...
DerivType operator/ ( const DerivType& u, const real& v )
  { return( u / _interval(v) ); }    // Can propagate 'division by zero' error
                                     //---------------------------------------
