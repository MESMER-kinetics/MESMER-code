...
/* CVS $Id: cimatrix.hpp,v 1.18 2007/05/16 14:58:55 cxsc Exp $ */
...
//=======================Vector / Scalar =========================
	...
	//! Returns the infinum of the matrix
	...
	//! Returns the infinum of real part of the matrix
	INLINE rmatrix InfRe(const cimatrix &v) throw();
	//! Returns the infinum of imaginary part of the matrix
	...
	//! Returns the matrix with the new given infinum value
	...
	throw();
#endif
	//! Returns the matrix with the new unchecked given infinum value
