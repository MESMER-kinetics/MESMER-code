...
/* CVS $Id: cinterval.hpp,v 1.5 2007/05/16 14:58:55 cxsc Exp $ */
...
class cinterval
{
   ...
   public:
      ...
      //! Returns the complex interval with the new given infinum value
      ...
      //! Returns the complex interval with the unchecked new given infinum value
