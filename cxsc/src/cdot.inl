...
/* CVS $Id: cdot.inl,v 1.16 2007/05/16 14:58:54 cxsc Exp $ */
...
inline cdotprecision operator -(const cdotprecision &a,const real &b) throw() { return cdotprecision(a.re-b,a.im); } 
inline cdotprecision operator -(const real &a,const cdotprecision &b)
throw() { return cdotprecision(a-b.re,b.im); }

inline cdotprecision operator +(const cdotprecision &a,
       const l_real &b) throw() 
{ return cdotprecision(a.re+b,a.im); } // Blomquist 17.09.02.
inline cdotprecision operator +(const l_real &b,
       const cdotprecision &a) throw() 
{ return cdotprecision(a.re+b,a.im); } // Blomquist 17.09.02.
inline cdotprecision operator -(const cdotprecision &a,
       const l_real &b) throw() 
{ return cdotprecision(a.re-b,a.im); } // Blomquist 17.09.02.
inline cdotprecision operator -(const l_real &b,
       const cdotprecision &a) throw() 
{ return cdotprecision(b-a.re,-a.im); } // Blomquist 17.09.02.
...
throw() { return(c==a.re && !a.im); }  // Blomquist 24.09.02
inline bool operator !=(const l_real &c,const cdotprecision &a)
throw() { return(c!=a.re || !!a.im); } // Blomquist 24.09.02
