...
/* CVS $Id: civector.hpp,v 1.17 2007/05/16 14:58:56 cxsc Exp $ */
...
//	INLINE civector _civector(const rmatrix_slice &sl) throw(ERROR_RMATRIX_TYPE_CAST_OF_THICK_OBJ);
	...
	//! Returns the vector with the new given infinum vector
	...
	throw();
#endif
	//! Returns the vector with the new unchecked given infinum vector
	...
	//! Returns the vector with the new given infinum value
	...
	//! Returns the vector with the new unchecked given infinum value
	...
	//! Returns the infinum of the vector
	...
	//! Returns the infinum of real part of the vector
	INLINE rvector InfRe(const civector &v) throw();
	//! Returns the infinum of imaginary part of the vector
