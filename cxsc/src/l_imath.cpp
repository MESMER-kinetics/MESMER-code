...
/* CVS $Id: l_imath.cpp,v 1.21 2007/05/16 14:59:00 cxsc Exp $ */
...
{ 
   ...
   else 
   {
      ...
      */
      ...
      // Argumentreduktion 2 wird rÅckgÑngig gemacht
      y = real(zhn1)*p;
      if (zwei) 
         y *= real(zhn2);

      // Argumentreduktion 1 wird rÅckgÑngig gemacht
      /*    if (neg) y = -(y);*/
