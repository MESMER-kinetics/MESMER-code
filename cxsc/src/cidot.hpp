...
/* CVS $Id: cidot.hpp,v 1.13 2007/05/16 14:58:54 cxsc Exp $ */
...
//             inline      operator void *() const throw();
      ...
      //! Returns the infinum of a complex dotprecison interval
      ...
      //! Returns the complex dotprecison interval with the new given infinum value
      ...
      //! Returns the complex dotprecison interval with the unchecked new given infinum value
      ...
      //! Returns the infinum of the real part of the complex dotprecision interval
      friend inline const dotprecision & InfRe(const cidotprecision &) throw();
      //! Returns the infinum of the imaginary part of the complex dotprecision interval
