...
/* CVS $Id: rvector.hpp,v 1.15 2007/05/16 14:59:04 cxsc Exp $ */
...
template <class MV,class V> friend  MV &_mvvsetre(MV &v,const V &rv)
 ...
 template <class VS,class V,class E> friend 	 E _vsvcmult(const VS & sl, const V &rv)
	...
	//! Returns componentwise the infinum of the real part
	friend INLINE rvector InfRe(const civector &v) throw();
	//! Returns componentwise the infinum of the imaginary part
