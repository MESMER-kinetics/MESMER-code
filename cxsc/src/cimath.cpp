...
/* CVS $Id: cimath.cpp,v 1.12 2007/05/16 14:58:55 cxsc Exp $ */
...
//
{
  if( n == 0 )
	...
	//  z contains 0
	  ...
	  //
	  if( irez * srez <= 0.0 && iimz * simz <= 0.0 && irez * srez * iimz * simz == 0.0 )
	    update_res( cinterval( ZERO_INTERVAL(), ZERO_INTERVAL()), resxl, resxu, resyl, resyu );
	  //
