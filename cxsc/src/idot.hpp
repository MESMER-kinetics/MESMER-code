...
/* CVS $Id: idot.hpp,v 1.12 2007/05/16 14:58:58 cxsc Exp $ */
...
//                         operator void *(void) throw() { return (void *)(!*this); }
      ...
      //! Returns the infinum of a dotprecison interval
      ...
      //! Returns the dotprecison interval with the new given infinum value
      ...
      //! Returns the dotprecison interval with the unchecked new given infinum value
