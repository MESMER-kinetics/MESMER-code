...
/* CVS $Id: interval.hpp,v 1.24 2007/05/16 14:58:58 cxsc Exp $ */
...
The notation \f$ \underline a \f$ denotes the lower bound (infinum), and \f$ \overline a \f$ denotes the upper bound (supremum) of the interval \f$ \left[ a \right]\f$. 
*/
class interval
{
   private:
