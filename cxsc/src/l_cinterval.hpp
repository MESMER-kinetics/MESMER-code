...
/* CVS $Id: l_cinterval.hpp,v 1.3 2007/05/16 14:59:00 cxsc Exp $ */
...
// --------------------- Comp.Operat.  ---------------------------------------
      ...
      //! Returns the infinum of the real interval of the complex interval
      friend inline l_real InfRe(const l_cinterval &a) throw() 
                                                     { return Inf(a.re); }
      //! Returns the infinum of the imaginary interval of the complex interval
