...
namespace mesmer
{
  ...
  bool HinderedRotorUtils::ReadMultiHinderedRotorPotential(PersistPtr pp) {
  ...
  double HinderedRotorUtils::CalculateMHRPotential() const {
