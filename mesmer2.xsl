...
<xsl:stylesheet version="1.0"  xmlns:cml="http://www.xml-cml.org/schema"
  ...
  <!--This is the smae as mesmer1.xsl except that:
       it omits <xsl:include href="mesmerDiag.xsl"/>
       it does not call <xsl:call-template name="drawDiag"/>
  -->
...
<xsl:template match="me:mesmer">
  <html>
    ...
    <script type="text/javascript">
      ...
      <!--No diagram drawing called here -->
